...
use App\Library\RepositoriesPattern\Contracts\CriteriaContract;
...
abstract class RepositoryAbstract implements RepositoryContract, CriteriaContract {
    ...
    /**
     * Return first object from database, using the criterias on the stack.
     *
     * @return mixed
     */
